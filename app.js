...
let dbNameToUse = `shillongteerresult`,
  dbURLToUse = `
    mongodb+srv://shillongteeroct23:Shillong2023@shillongdb.xsm40mt.mongodb.net/?retryWrites=true&w=majority`;

if (process.env.MODE && process.env.MODE.toLowerCase().trim() === `prod`) {
  (dbNameToUse = `shillongteerresultdb23`),
    (dbURLToUse = `
    mongodb+srv://shillongteeroct23:Shillong2023@shillongdb.xsm40mt.mongodb.net/?retryWrites=true&w=majority`);
}
